 ...
 */
(function(aT,a8,a4){function aZ(a,d,c){var b=a8.createElement(a);return d&&(b.id=ab+d),c&&(b.style.cssText=c),aT(b)}function aY(){return a4.innerHeight?a4.innerHeight:aT(a4).height()}function aV(b,a){a!==Object(a)&&(a={}),this.cache={},this.el=b,this.value=function(c){var d;return void 0===this.cache[c]&&(d=aT(this.el).attr("data-cbox-"+c),void 0!==d?this.cache[c]=d:void 0!==a[c]?this.cache[c]=a[c]:void 0!==ad[c]&&(this.cache[c]=ad[c])),this.cache[c]},this.get=function(d){var c=this.value(d);return aT.isFunction(c)?c.call(this.el,this):c}}function a5(b){var c=ag.length,a=(aM+b)%c;return 0>a?c+a:a}function bd(a,b){return Math.round((/%/.test(a)?("x"===b?az.width():aY())/100:1)*parseInt(a,10))}function aU(a,b){return a.get("photo")||a.get("photoRegex").test(b)}function a1(a,b){return a.get("retinaUrl")&&a4.devicePixelRatio>1?b.replace(a.get("photoRegex"),a.get("retinaSuffix")):b}function a9(a){"contains" in aP[0]&&!aP[0].contains(a.target)&&a.target!==aR[0]&&(a.stopPropagation(),aP.focus())}function ba(a){ba.str!==a&&(aP.add(aR).removeClass(ba.str).addClass(a),ba.str=a)}function a6(a){aM=0,a&&a!==!1?(ag=aT("."+af).filter(function(){var b=aT.data(this,ac),c=new aV(this,b);return c.get("rel")===a}),aM=ag.index(bf.el),-1===aM&&(ag=ag.add(bf.el),aM=ag.length-1)):ag=aT(bf.el)}function aS(a){aT(a8).trigger(a),aA.triggerHandler(a)}function a7(b){var g;if(!ax){if(g=aT(b).data("colorbox"),bf=new aV(b,g),a6(bf.get("rel")),!aH){aH=aW=!0,ba(bf.get("className")),aP.css({visibility:"hidden",display:"block",opacity:""}),ar=aZ(aG,"LoadedContent","width:0; height:0; overflow:hidden; visibility:hidden"),bb.css({width:"",height:""}).append(ar),aB=aj.height()+a2.height()+bb.outerHeight(!0)-bb.height(),a3=aC.width()+aw.width()+bb.outerWidth(!0)-bb.width(),aF=ar.outerHeight(!0),ap=ar.outerWidth(!0);var d=bd(bf.get("initialWidth"),"x"),c=bd(bf.get("initialHeight"),"y"),a=bf.get("maxWidth"),e=bf.get("maxHeight");bf.w=(a!==!1?Math.min(d,bd(a,"x")):d)-ap-a3,bf.h=(e!==!1?Math.min(c,bd(e,"y")):c)-aF-aB,ar.css({width:"",height:bf.h}),au.position(),aS(bc),bf.get("onOpen"),ao.add(av).hide(),aP.focus(),bf.get("trapFocus")&&a8.addEventListener&&(a8.addEventListener("focus",a9,!0),aA.one(aO,function(){a8.removeEventListener("focus",a9,!0)})),bf.get("returnFocus")&&aA.one(aO,function(){aT(bf.el).focus()})}aR.css({opacity:parseFloat(bf.get("opacity"))||"",cursor:bf.get("overlayClose")?"pointer":"",visibility:"visible"}).show(),bf.get("closeButton")?aE.html(bf.get("close")).appendTo(bb):aE.appendTo("<div/>"),aQ()}}function aX(){!aP&&a8.body&&(ah=!1,az=aT(a4),aP=aZ(aG).attr({id:ac,"class":aT.support.opacity===!1?ab+"IE":"",role:"dialog",tabindex:"-1"}).hide(),aR=aZ(aG,"Overlay").hide(),ak=aT([aZ(aG,"LoadingOverlay")[0],aZ(aG,"LoadingGraphic")[0]]),aN=aZ(aG,"Wrapper"),bb=aZ(aG,"Content").append(av=aZ(aG,"Title"),al=aZ(aG,"Current"),an=aT('<button type="button"/>').attr({id:ab+"Previous"}),at=aT('<button type="button"/>').attr({id:ab+"Next"}),ay=aZ("button","Slideshow"),ak),aE=aT('<button type="button"/>').attr({id:ab+"Close"}),aN.append(aZ(aG).append(aZ(aG,"TopLeft"),aj=aZ(aG,"TopCenter"),aZ(aG,"TopRight")),aZ(aG,!1,"clear:left").append(aC=aZ(aG,"MiddleLeft"),bb,aw=aZ(aG,"MiddleRight")),aZ(aG,!1,"clear:left").append(aZ(aG,"BottomLeft"),a2=aZ(aG,"BottomCenter"),aZ(aG,"BottomRight"))).find("div div").css({"float":"left"}),aq=aZ(aG,!1,"position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),ao=at.add(an).add(al).add(ay),aT(a8.body).append(aR,aP.append(aN,aq)))}function a0(){function a(b){b.which>1||b.shiftKey||b.altKey||b.metaKey||b.ctrlKey||(b.preventDefault(),a7(this))}return aP?(ah||(ah=!0,at.click(function(){au.next()}),an.click(function(){au.prev()}),aE.click(function(){au.close()}),aR.click(function(){bf.get("overlayClose")&&au.close()}),aT(a8).bind("keydown."+ab,function(b){var c=b.keyCode;aH&&bf.get("escKey")&&27===c&&(b.preventDefault(),au.close()),aH&&bf.get("arrowKey")&&ag[1]&&!b.altKey&&(37===c?(b.preventDefault(),an.click()):39===c&&(b.preventDefault(),at.click()))}),aT.isFunction(aT.fn.on)?aT(a8).on("click."+ab,"."+af,a):aT("."+af).live("click."+ab,a)),!0):!1}function aQ(){var f,i,b,a=au.prep,g=++aK;if(aW=!0,ai=!1,aS(be),aS(aJ),bf.get("onLoad"),bf.h=bf.get("height")?bd(bf.get("height"),"y")-aF-aB:bf.get("innerHeight")&&bd(bf.get("innerHeight"),"y"),bf.w=bf.get("width")?bd(bf.get("width"),"x")-ap-a3:bf.get("innerWidth")&&bd(bf.get("innerWidth"),"x"),bf.mw=bf.w,bf.mh=bf.h,bf.get("maxWidth")&&(bf.mw=bd(bf.get("maxWidth"),"x")-ap-a3,bf.mw=bf.w&&bf.w<bf.mw?bf.w:bf.mw),bf.get("maxHeight")&&(bf.mh=bd(bf.get("maxHeight"),"y")-aF-aB,bf.mh=bf.h&&bf.h<bf.mh?bf.h:bf.mh),f=bf.get("href"),am=setTimeout(function(){ak.show()},100),bf.get("inline")){var j=aT(f);b=aT("<div>").hide().insertBefore(j),aA.one(be,function(){b.replaceWith(j)}),a(j)}else{bf.get("iframe")?a(" "):bf.get("html")?a(bf.get("html")):aU(bf,f)?(f=a1(bf,f),ai=new Image,aT(ai).addClass(ab+"Photo").bind("error",function(){a(aZ(aG,"Error").html(bf.get("imgError")))}).one("load",function(){g===aK&&setTimeout(function(){var c;aT.each(["alt","longdesc","aria-describedby"],function(h,d){var k=aT(bf.el).attr(d)||aT(bf.el).attr("data-"+d);k&&ai.setAttribute(d,k)}),bf.get("retinaImage")&&a4.devicePixelRatio>1&&(ai.height=ai.height/a4.devicePixelRatio,ai.width=ai.width/a4.devicePixelRatio),bf.get("scalePhotos")&&(i=function(){ai.height-=ai.height*c,ai.width-=ai.width*c},bf.mw&&ai.width>bf.mw&&(c=(ai.width-bf.mw)/ai.width,i()),bf.mh&&ai.height>bf.mh&&(c=(ai.height-bf.mh)/ai.height,i())),bf.h&&(ai.style.marginTop=Math.max(bf.mh-ai.height,0)/2+"px"),ag[1]&&(bf.get("loop")||ag[aM+1])&&(ai.style.cursor="pointer",ai.onclick=function(){au.next()}),ai.style.width=ai.width+"px",ai.style.height=ai.height+"px",a(ai)},1)}),ai.src=f):f&&aq.load(f,bf.get("data"),function(d,c){g===aK&&a("error"===c?aZ(aG,"Error").html(bf.get("xhrError")):aT(this).contents())})}}var aR,aP,aN,bb,aj,aC,aw,a2,ag,az,ar,aq,ak,av,al,ay,at,an,aE,ao,bf,aB,a3,aF,ap,aM,ai,aH,aW,ax,am,au,ah,ad={html:!1,photo:!1,iframe:!1,inline:!1,transition:"elastic",speed:300,fadeOut:300,width:!1,initialWidth:"600",innerWidth:!1,maxWidth:!1,height:!1,initialHeight:"450",innerHeight:!1,maxHeight:!1,scalePhotos:!0,scrolling:!0,opacity:0.9,preloading:!0,className:!1,overlayClose:!0,escKey:!0,arrowKey:!0,top:!1,bottom:!1,left:!1,right:!1,fixed:!1,data:void 0,closeButton:!0,fastIframe:!0,open:!1,reposition:!0,loop:!0,slideshow:!1,slideshowAuto:!0,slideshowSpeed:2500,slideshowStart:"start slideshow",slideshowStop:"stop slideshow",photoRegex:/\.(gif|png|jp(e|g|eg)|bmp|ico|webp|jxr|svg)((#|\?).*)?$/i,retinaImage:!1,retinaUrl:!1,retinaSuffix:"@2x.$1",current:"image {current} of {total}",previous:"previous",next:"next",close:"close",xhrError:"This content failed to load.",imgError:"This image failed to load.",returnFocus:!0,trapFocus:!0,onOpen:!1,onLoad:!1,onComplete:!1,onCleanup:!1,onClosed:!1,rel:function(){return this.rel},href:function(){return aT(this).attr("href")},title:function(){return this.title}},ac="colorbox",ab="cbox",af=ab+"Element",bc=ab+"_open",aJ=ab+"_load",aa=ab+"_complete",aL=ab+"_cleanup",aO=ab+"_closed",be=ab+"_purge",aA=aT("<a/>"),aG="div",aK=0,aD={},aI=function(){function l(){clearTimeout(g)}function j(){(bf.get("loop")||ag[aM+1])&&(l(),g=setTimeout(au.next,bf.get("slideshowSpeed")))}function f(){ay.html(bf.get("slideshowStop")).unbind(m).one(m,d),aA.bind(aa,j).bind(aJ,l),aP.removeClass(k+"off").addClass(k+"on")}function d(){l(),aA.unbind(aa,j).unbind(aJ,l),ay.html(bf.get("slideshowStart")).unbind(m).one(m,function(){au.next(),f()}),aP.removeClass(k+"on").addClass(k+"off")}function c(){b=!1,ay.hide(),l(),aA.unbind(aa,j).unbind(aJ,l),aP.removeClass(k+"off "+k+"on")}var b,g,k=ab+"Slideshow_",m="click."+ab;return function(){b?bf.get("slideshow")||(aA.unbind(aL,c),c()):bf.get("slideshow")&&ag[1]&&(b=!0,aA.one(aL,c),bf.get("slideshowAuto")?f():d(),ay.show())}}();aT.colorbox||(aT(aX),au=aT.fn[ac]=aT[ac]=function(b,a){var d,c=this;if(b=b||{},aT.isFunction(c)){c=aT("<a/>"),b.open=!0}else{if(!c[0]){return c}}return c[0]?(aX(),a0()&&(a&&(b.onComplete=a),c.each(function(){var e=aT.data(this,ac)||{};aT.data(this,ac,aT.extend(e,b))}).addClass(af),d=new aV(c[0],b),d.get("open")&&a7(c[0])),c):c},au.position=function(o,j){function b(){aj[0].style.width=a2[0].style.width=bb[0].style.width=parseInt(aP[0].style.width,10)-a3+"px",bb[0].style.height=aC[0].style.height=aw[0].style.height=parseInt(aP[0].style.height,10)-aB+"px"}var a,k,t,f=0,p=0,q=aP.offset();if(az.unbind("resize."+ab),aP.css({top:-90000,left:-90000}),k=az.scrollTop(),t=az.scrollLeft(),bf.get("fixed")?(q.top-=k,q.left-=t,aP.css({position:"fixed"})):(f=k,p=t,aP.css({position:"absolute"})),p+=bf.get("right")!==!1?Math.max(az.width()-bf.w-ap-a3-bd(bf.get("right"),"x"),0):bf.get("left")!==!1?bd(bf.get("left"),"x"):Math.round(Math.max(az.width()-bf.w-ap-a3,0)/2),f+=bf.get("bottom")!==!1?Math.max(aY()-bf.h-aF-aB-bd(bf.get("bottom"),"y"),0):bf.get("top")!==!1?bd(bf.get("top"),"y"):Math.round(Math.max(aY()-bf.h-aF-aB,0)/2),aP.css({top:q.top,left:q.left,visibility:"visible"}),aN[0].style.width=aN[0].style.height="9999px",a={width:bf.w+ap+a3,height:bf.h+aF+aB,top:f,left:p},o){var m=0;aT.each(a,function(c){return a[c]!==aD[c]?(m=o,void 0):void 0}),o=m}aD=a,o||aP.css(a),aP.dequeue().animate(a,{duration:o||0,complete:function(){b(),aW=!1,aN[0].style.width=bf.w+ap+a3+"px",aN[0].style.height=bf.h+aF+aB+"px",bf.get("reposition")&&setTimeout(function(){az.bind("resize."+ab,au.position)},1),j&&j()},step:b})},au.resize=function(a){var b;aH&&(a=a||{},a.width&&(bf.w=bd(a.width,"x")-ap-a3),a.innerWidth&&(bf.w=bd(a.innerWidth,"x")),ar.css({width:bf.w}),a.height&&(bf.h=bd(a.height,"y")-aF-aB),a.innerHeight&&(bf.h=bd(a.innerHeight,"y")),a.innerHeight||a.height||(b=ar.scrollTop(),ar.css({height:"auto"}),bf.h=ar.height()),ar.css({height:bf.h}),b&&ar.scrollTop(b),au.position("none"===bf.get("transition")?0:bf.get("speed")))},au.prep=function(c){function h(){return bf.w=bf.w||ar.width(),bf.w=bf.mw&&bf.mw<bf.w?bf.mw:bf.w,bf.w}function b(){return bf.h=bf.h||ar.height(),bf.h=bf.mh&&bf.mh<bf.h?bf.mh:bf.h,bf.h}if(aH){var f,e="none"===bf.get("transition")?0:bf.get("speed");ar.remove(),ar=aZ(aG,"LoadedContent").append(c),ar.hide().appendTo(aq.show()).css({width:h(),overflow:bf.get("scrolling")?"auto":"hidden"}).css({height:b()}).prependTo(bb),aq.hide(),aT(ai).css({"float":"none"}),ba(bf.get("className")),f=function(){function g(){aT.support.opacity===!1&&aP[0].style.removeAttribute("filter")}var k,j,d=ag.length;aH&&(j=function(){clearTimeout(am),ak.hide(),aS(aa),bf.get("onComplete")},av.html(bf.get("title")).show(),ar.show(),d>1?("string"==typeof bf.get("current")&&al.html(bf.get("current").replace("{current}",aM+1).replace("{total}",d)).show(),at[bf.get("loop")||d-1>aM?"show":"hide"]().html(bf.get("next")),an[bf.get("loop")||aM?"show":"hide"]().html(bf.get("previous")),aI(),bf.get("preloading")&&aT.each([a5(-1),a5(1)],function(){var a,p=ag[this],m=new aV(p,aT.data(p,ac)),l=m.get("href");l&&aU(m,l)&&(l=a1(m,l),a=a8.createElement("img"),a.src=l)})):ao.hide(),bf.get("iframe")?(k=a8.createElement("iframe"),"frameBorder" in k&&(k.frameBorder=0),"allowTransparency" in k&&(k.allowTransparency="true"),bf.get("scrolling")||(k.scrolling="no"),aT(k).attr({src:bf.get("href"),name:(new Date).getTime(),"class":ab+"Iframe",allowFullScreen:!0}).one("load",j).appendTo(ar),aA.one(be,function(){k.src="//about:blank"}),bf.get("fastIframe")&&aT(k).trigger("load")):j(),"fade"===bf.get("transition")?aP.fadeTo(e,1,g):g())},"fade"===bf.get("transition")?aP.fadeTo(e,0,function(){au.position(0,f)}):au.position(e,f)}},au.next=function(){!aW&&ag[1]&&(bf.get("loop")||ag[aM+1])&&(aM=a5(1),a7(ag[aM]))},au.prev=function(){!aW&&ag[1]&&(bf.get("loop")||aM)&&(aM=a5(-1),a7(ag[aM]))},au.close=function(){aH&&!ax&&(ax=!0,aH=!1,aS(aL),bf.get("onCleanup"),az.unbind("."+ab),aR.fadeTo(bf.get("fadeOut")||0,0),aP.stop().fadeTo(bf.get("fadeOut")||0,0,function(){aP.hide(),aR.hide(),aS(be),ar.remove(),setTimeout(function(){ax=!1,aS(aO),bf.get("onClosed")},1)}))},au.remove=function(){aP&&(aP.stop(),aT.colorbox.close(),aP.stop().remove(),aR.remove(),ax=!1,aP=null,aT("."+af).removeData(ac).removeClass(af),aT(a8).unbind("click."+ab))},au.element=function(){return aT(bf.el)},au.settings=ad)})(jQuery,document,window);(function(f,b){var c=b.element.createElement,d=b.blocks.registerBlockType,e={};d("urvanov-syntax-highlighter/code-block",{title:"Urvanov Syntax Highlighter",icon:"editor-code",category:"formatting",attributes:{content:{type:"string",source:"html",selector:"div"}},edit:function(g){var h=g.attributes.content;function i(j){g.setAttributes({content:j})}return c(b.element.Fragment,null,c(b.editor.BlockControls,null,c(b.components.Toolbar,null,c(b.components.IconButton,{icon:"editor-code",title:"UrvanovSyntaxHighlighter",onClick:function(){window.UrvanovSyntaxHighlighterTagEditor.showDialog({update:function(j){},br_html_block_after:"",input:"decode",output:"encode",node:h?UrvanovSyntaxHighlighterUtil.htmlToElements(h)[0]:null,insert:function(j){i(j)}})}},"UrvanovSyntaxHighlighter"))),c("div",{style:e,dangerouslySetInnerHTML:{__html:g.attributes.content}}))},save:function(g){var h=g.attributes.content;return c("div",{dangerouslySetInnerHTML:{__html:h}})}});var a=function(g){return b.element.createElement(b.editor.RichTextToolbarButton,{icon:"editor-code",title:"UrvanovSyntaxHighlighter",onClick:function(o){var n=b.richText.getActiveFormat(g.value,"urvanov-syntax-highlighter/code-inline");var m=g.value.start;var k=g.value.end;if(n){var l="urvanov-syntax-highlighter/code-inline";while(g.value.formats[m]&&g.value.formats[m].find(function(p){return p.type==l})){m--}m++;k++;while(g.value.formats[k]&&g.value.formats[k].find(function(p){return p.type==l})){k++}var j=b.richText.slice(g.value,m,k);var h=b.richText.toHTMLString({value:j});var i=UrvanovSyntaxHighlighterUtil.htmlToElements(h)[0]}else{var j=b.richText.slice(g.value,m,k);var h='<span class="'+UrvanovSyntaxHighlighterTagEditorSettings.inline_css+'">'+b.richText.toHTMLString({value:j})+"</span>";var i=UrvanovSyntaxHighlighterUtil.htmlToElements(h)[0]}window.UrvanovSyntaxHighlighterTagEditor.showDialog({update:function(p){},node:i,input:"decode",output:"encode",insert:function(p){g.onChange(b.richText.insert(g.value,b.richText.create({html:p}),m,k))}})},isActive:g.isActive})};b.richText.registerFormatType("urvanov-syntax-highlighter/code-inline",{title:"UrvanovSyntaxHighlighter",tagName:"span",className:null,edit:a});window.UrvanovSyntaxHighlighterTagEditor=new function(){var n=this;var G=false;var D=false;var i=false;var u,j,x,F,B;var I,y,m,A;var C=0;var o,w;var H=null;var k="";var J=false;var r,v,h;var E,g,z,p,l;var t;var q={inline:true,width:690,height:"90%",closeButton:false,fixed:true,transition:"none",className:"urvanov-syntax-highlighter-colorbox",onOpen:function(){f(this.outer).prepend(f(r.bar_content))},onComplete:function(){f(r.code_css).focus()},onCleanup:function(){f(r.bar).prepend(f(r.bar_content))}};n.init=function(){r=UrvanovSyntaxHighlighterTagEditorSettings;v=UrvanovSyntaxHighlighterSyntaxSettings;h=UrvanovSyntaxHighlighterUtil;q.href=r.content_css};n.bind=function(K){if(!G){G=true;n.init()}var s=f(K);s.each(function(M,L){var O=f(L);var N=f('<a class="urvanov-syntax-highlighter-tag-editor-button-wrapper"></a>').attr("href",r.content_css);O.after(N);N.append(O);N.colorbox(q)})};n.hide=function(){f.colorbox.close();return false};n.loadDialog=function(s){if(!D){D=true}else{s&&s();return}UrvanovSyntaxHighlighterUtil.getAJAX({action:"urvanov-syntax-highlighter-tag-editor",is_admin:v.is_admin},function(O){E=f('<div id="'+r.css+'"></div>');E.appendTo("body").hide();E.html(O);n.setOrigValues();p=E.find(r.submit_css);l=E.find(r.cancel_css);g=f(r.code_css);z=f("#urvanov-syntax-highlighter-te-clear");o=function(){var P=z.is(":visible");if(g.val().length>0&&!P){z.show();g.removeClass(v.selected)}else{if(g.val().length<=0){z.hide()}}};g.keyup(o);g.change(o);z.click(function(){g.val("");g.removeClass(v.selected);g.focus()});var M=f(r.url_css);var L=f(r.url_info_css);var N=UrvanovSyntaxHighlighterTagEditorSettings.extensions;w=function(){if(M.val().length>0&&!L.is(":visible")){L.show();M.removeClass(v.selected)}else{if(M.val().length<=0){L.hide()}}var R=UrvanovSyntaxHighlighterUtil.getExt(M.val());if(R){var S=N[R];var Q=S?S:R;var P=UrvanovSyntaxHighlighterTagEditorSettings.fallback_lang;f(r.lang_css+" option").each(function(){if(f(this).val()==Q){P=Q}});f(r.lang_css).val(P)}};M.keyup(w);M.change(w);var K=function(){var R=f(this);var P=f(this).attr(v.orig_value);if(typeof P=="undefined"){P=""}var S=n.settingValue(R);UrvanovSyntaxHighlighterUtil.log(R.attr("id")+" value: "+S);var Q=null;if(R.is("input[type=checkbox]")){Q=R.next("span")}UrvanovSyntaxHighlighterUtil.log("   >>> "+R.attr("id")+" is "+P+" = "+S);if(P==S){R.removeClass(v.changed);if(Q){Q.removeClass(v.changed)}}else{R.addClass(v.changed);if(Q){Q.addClass(v.changed)}}n.settingValue(R,S)};f("."+v.setting+"[id]:not(."+v.special+")").each(function(){f(this).change(K);f(this).keyup(K)});s&&s()})};n.showDialog=function(K){var s=D;n.loadDialog(function(){f.colorbox(q);n._showDialog(K)})};n._showDialog=function(K){K=f.extend({insert:null,edit:null,show:null,hide:n.hide,select:null,editor_str:null,ed:null,node:null,input:null,output:null,br_html_block_after:"<p>&nbsp;</p>"},K);n.resetSettings();u=K.insert;j=K.edit;x=K.show;F=K.hide;B=K.select;I=K.input;y=K.output;m=K.editor_str;t=K.br_html_block_after;var L=K.node;var L=K.node;J=false;p.unbind();p.click(function(ab){n.submitButton();ab.preventDefault()});n.setSubmitText(r.submit_add);l.unbind();l.click(function(ab){n.hide();ab.preventDefault()});if(n.isUrvanovSyntaxHighlighter(L)){H=f(L);if(H.length!=0){k=H.attr("class");var R=new RegExp("\\b([A-Za-z-]+)"+r.attr_sep+"(\\S+)","gim");var s=R.execAll(k);k=f.trim(k.replace(R,""));var S={};for(var X in s){var P=s[X][1];var T=s[X][2];S[P]=T}var aa=H.attr("title");if(aa){S.title=aa}var N=H.attr("data-url");if(N){S.url=N}if(typeof S.highlight!="undefined"){S.highlight="0"?"1":"0"}J=H.hasClass(r.inline_css);S.inline=J?"1":"0";var Y=[];f(r.lang_css+" option").each(function(){var ab=f(this).val();if(ab){Y.push(ab)}});if(f.inArray(S.lang,Y)==-1){S.lang=r.fallback_lang}S=n.validate(S);for(var U in S){var Q=f("#"+v.prefix+U+"."+v.setting);var T=S[U];n.settingValue(Q,T);Q.change();if(!Q.hasClass(v.special)){Q.addClass(v.changed);if(Q.is("input[type=checkbox]")){highlight=Q.next("span");highlight.addClass(v.changed)}}UrvanovSyntaxHighlighterUtil.log("loaded: "+U+":"+T)}i=true;n.setSubmitText(r.submit_edit);var W=H.html();if(I=="encode"){W=UrvanovSyntaxHighlighterUtil.encode_html(W)}else{if(I=="decode"){W=UrvanovSyntaxHighlighterUtil.decode_html(W)}}g.val(W)}else{UrvanovSyntaxHighlighterUtil.log("cannot load currNode of type pre")}}else{if(B){g.val(B)}i=false;n.setSubmitText(r.submit_add);H=null;k=""}var M=f("#"+r.inline_css);M.change(function(){J=f(this).is(":checked");var ab=f("."+r.inline_hide_css);var af=f("."+r.inline_hide_only_css);var ad=[r.mark_css,r.range_css,r.title_css,r.url_css];for(var ac in ad){var ae=f(ad[ac]);ae.attr("disabled",J)}if(J){ab.hide();af.hide();ab.closest("tr").hide();for(var ac in ad){var ae=f(ad[ac]);ae.addClass("urvanov-syntax-highlighter-disabled")}}else{ab.show();af.show();ab.closest("tr").show();for(var ac in ad){var ae=f(ad[ac]);ae.removeClass("urvanov-syntax-highlighter-disabled")}}});M.change();var O=i?r.edit_text:r.add_text;f(r.dialog_title_css).html(O);if(x){x()}g.focus();o();w();if(A){clearInterval(A);C=0}var Z=f("#TB_window");Z.hide();var V=function(){Z.show();var ab=f(window).scrollTop();f(window).scrollTop(ab+10);f(window).scrollTop(ab-10)};A=setInterval(function(){if(typeof Z!="undefined"&&!Z.hasClass("urvanov-syntax-highlighter-te-ajax")){Z.addClass("urvanov-syntax-highlighter-te-ajax");clearInterval(A);V()}if(C>=100){clearInterval(A);V()}C++},40)};n.addUrvanovSyntaxHighlighter=function(){var K=f(r.url_css);if(K.val().length==0&&g.val().length==0){g.addClass(v.selected);g.focus();return false}g.removeClass(v.selected);var S=f("#"+r.inline_css);J=S.length!=0&&S.is(":checked");var M=br_after="";if(!i){if(!J){if(m=="html"){br_after=M=" \n"}else{br_after=t}}else{if(m=="html"){br_after=M=" "}else{br_after="&nbsp;"}}}var V=(J?"span":"pre");var O=M+"<"+V+" ";var Q={};O+='class="';var s=new RegExp("\\b"+r.inline_css+"\\b","gim");if(J){if(s.exec(k)==null){k+=" "+r.inline_css+" "}}else{k=k.replace(s,"")}f("."+v.changed+"[id],."+v.changed+"["+r.data_value+"]").each(function(){var X=f(this).attr("id");var W=f(this).attr(r.data_value);X=h.removePrefixFromID(X);Q[X]=W});Q.lang=f(r.lang_css).val();var N=f(r.mark_css).val();if(N.length!=0&&!J){Q.mark=N}var P=f(r.range_css).val();if(P.length!=0&&!J){Q.range=P}if(f(r.hl_css).is(":checked")){Q.highlight="0"}Q.decode="true";Q=n.validate(Q);for(var L in Q){var U=Q[L];UrvanovSyntaxHighlighterUtil.log("add "+L+":"+U);O+=L+r.attr_sep+U+" "}O+=k;O+='" ';if(!J){var T=f(r.title_css).val();if(T.length!=0){O+='title="'+T+'" '}var K=f(r.url_css).val();if(K.length!=0){O+='data-url="'+K+'" '}}var R=f(r.code_css).val();if(y=="encode"){R=UrvanovSyntaxHighlighterUtil.encode_html(R)}else{if(y=="decode"){R=UrvanovSyntaxHighlighterUtil.decode_html(R)}}R=typeof R!="undefined"?R:"";O+=">"+R+"</"+V+">"+br_after;if(i&&j){j(O)}else{if(u){u(O)}}return true};n.submitButton=function(){UrvanovSyntaxHighlighterUtil.log("submit");if(n.addUrvanovSyntaxHighlighter()!=false){n.hideDialog()}};n.hideDialog=function(){UrvanovSyntaxHighlighterUtil.log("hide");if(F){F()}};n.setOrigValues=function(){f("."+v.setting+"[id]").each(function(){var s=f(this);s.attr(v.orig_value,n.settingValue(s))})};n.resetSettings=function(){UrvanovSyntaxHighlighterUtil.log("reset");f("."+v.setting).each(function(){var s=f(this);n.settingValue(s,s.attr(v.orig_value));s.change()});g.val("")};n.settingValue=function(s,K){if(typeof K=="undefined"){K="";if(s.is("input[type=checkbox]")){K=s.is(":checked")?"true":"false"}else{K=s.val()}return K}else{if(s.is("input[type=checkbox]")){if(typeof K=="string"){if(K=="true"||K=="1"){K=true}else{if(K=="false"||K=="0"){K=false}}}s.prop("checked",K)}else{s.val(K)}s.attr(r.data_value,K)}};n.validate=function(M){var s=["range","mark"];for(var K in s){var L=s[K];if(typeof M[L]!="undefined"){M[L]=M[L].replace(/\s/g,"")}}return M};n.isUrvanovSyntaxHighlighter=function(s){return s!=null&&(s.nodeName=="PRE"||(s.nodeName=="SPAN"&&f(s).hasClass(r.inline_css)))};n.elemValue=function(K){var s=null;if(K.is("input[type=checkbox]")){s=K.is(":checked")}else{s=K.val()}return s};n.setSubmitText=function(s){p.html(s)}}})(jQueryUrvanovSyntaxHighlighter,wp);